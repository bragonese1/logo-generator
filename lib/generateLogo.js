...
<svg width="300" height="200" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="150" y="105" font-size="60" text-anchor="middle" fill="${textColor}">${text}</text> <!-- TEXT for LOGO-->
</svg>
`;

 // Write the SVG content to 'logo.svg' file and returning the promise
 return writeFile('logo.svg', logoContent.trim())//trim for any whitespace
 .then(() => {
